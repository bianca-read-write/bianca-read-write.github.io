      ...
      <ul className="nav flex-column">
        <li
          className={
            ...
            props.location.pathname === process.env.PUBLIC_URL + "/"
              ? "current-nav-item"
              : "")
          }
        >
        ...
        >
          <a title="Event" href={process.env.PUBLIC_URL + "/event"}>
            Event
          </a>
        </li>
        ...
        <li
          className={
            "nav-item " +
            (window.location.pathname.includes("/rsvp")
              ? "current-nav-item"
              : "")
          }
        >
          <a title="RSVP" href={process.env.PUBLIC_URL + "/rsvp"}>
            RSVP
          </a>
        </li>
        ...
        >
          <a title="Gifts" href={process.env.PUBLIC_URL + "/gifts"}>
            Gifts
          </a>
        </li>
        ...
        >
          <a title="Travel" href={process.env.PUBLIC_URL + "/travel"}>
            Travel
          </a>
        </li>
      </ul>
