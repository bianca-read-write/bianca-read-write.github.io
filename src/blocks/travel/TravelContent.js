            ...
            <div className="col-sm-8 col-md-8 col-lg-7 col-xl-7 align-self-center">
              ...
              <div className="description max-width-1">
                <p>
                  ...
                  is located in DUMBO, Brooklyn, just across the river from
                  Lower Manhattan. Given parking in DUMBO is extremeley limited,
                  we suggest minimizing car usage or planning on using
        ...
        <div className="wrapper">
          <div className="row gutter-width-md with-pb-md">
            <div className="col-sm-8 col-md-8 col-lg-7 col-xl-7 align-self-center">
              ...
              <div className="description max-width-1">
                <p>
                  Have a jam-packed adventure in the city that never sleeps!
                  We’ve created a list of our favorite things to do in DUMBO and
                  across New York City to make sure you can get a taste of
                  everything NYC has to offer. For more ideas, check out{" "}
                  <a
                    className="underline"
              ...
              <div className="description max-width-1 spacer p-top-lg">
                ...
                <p>
                  ...
                  impressive selection of parties and snacks.
                </p>
                <p>
                  <a
                    className="btn btn-link btn-line p-0 border-0 min-w-auto text-uppercase"
                ...
                <h5 className="spacer p-top-lg">NYC</h5>
                <p>
                  <a
                    className="btn btn-link btn-line p-0 border-0 min-w-auto text-uppercase"
                  ...
                  on the greenway, grab some ice cream and snacks, and bask in
                  the beautiful views. Feeling hungry? Head over to Chelsea
                  Market for some great bites and gifts.
                </p>
                <p>
                  <a
                    className="btn btn-link btn-line p-0 border-0 min-w-auto text-uppercase"
                ...
                <p>
                  ...
                  for hip shopping and great food. Be sure to check out the
                  newly constructed Domino Park for cool city views.
                </p>
              </div>
            </div>
          </div>
